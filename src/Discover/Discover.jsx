  ...
  return (
    <div className="bg-[#212525] pl-[120px] pr-[120px]  ">
      ...
      <div className=" md:flex justify-between items-center  pt-10 ">
        <img className="mb-0 " src="/src/assets/Rectangle- second 1.png" alt="" />
        <img className="" src="/src/assets/Rectangle- second 2.png" alt="" />
        <img className="mb-0" src="/src/assets/Rectangle- second 3.png" alt="" />
      </div>
    </div>
  );
};
